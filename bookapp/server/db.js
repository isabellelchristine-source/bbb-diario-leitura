...
-- Inscrições de notificação push (uma por navegador/celular em que a pessoa autorizou).
-- Uma mesma usuária pode ter mais de uma linha aqui (ex: celular + computador).
