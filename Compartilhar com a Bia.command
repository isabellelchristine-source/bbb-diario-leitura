...
# pra mandar pra Bia acessar de qualquer lugar. Seu computador precisa continuar
# ligado e com esta janela aberta enquanto ela estiver usando.
cd "$(dirname "$0")"
...
if ! command -v cloudflared >/dev/null 2>&1; then
  ...
  if command -v brew >/dev/null 2>&1; then
    ...
    echo ""
    echo "Não encontrei o Homebrew no seu Mac. Instale o cloudflared manualmente:"
...
echo "  copie e mande pra Bia. Ela só precisa clicar — não instala nada."
echo "=================================================================="
echo ""
